---
type: definition
id: sample-efficient-marginal-nonuniform-agnostic-proper-pac
title: Sample-Efficient Marginal-Nonuniform Agnostic Proper PAC Learning
...
# Sample-Efficient Marginal-Nonuniform Agnostic Proper PAC Learning
...
WHERE type = "implication" AND source = "sample-efficient-marginal-nonuniform-agnostic-proper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "sample-efficient-marginal-nonuniform-agnostic-proper-pac"
SORT source ASC
```
