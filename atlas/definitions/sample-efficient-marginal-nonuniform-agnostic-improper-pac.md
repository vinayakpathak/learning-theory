---
type: definition
id: sample-efficient-marginal-nonuniform-agnostic-improper-pac
title: Sample-Efficient Marginal-Nonuniform Agnostic Improper PAC Learning
...
# Sample-Efficient Marginal-Nonuniform Agnostic Improper PAC Learning
...
WHERE type = "implication" AND source = "sample-efficient-marginal-nonuniform-agnostic-improper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "sample-efficient-marginal-nonuniform-agnostic-improper-pac"
SORT source ASC
```
