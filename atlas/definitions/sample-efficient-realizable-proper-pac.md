---
type: definition
id: sample-efficient-realizable-proper-pac
title: Sample-Efficient Realizable Proper PAC Learning
...
# Sample-Efficient Realizable Proper PAC Learning
...
WHERE type = "implication" AND source = "sample-efficient-realizable-proper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "sample-efficient-realizable-proper-pac"
SORT source ASC
```
