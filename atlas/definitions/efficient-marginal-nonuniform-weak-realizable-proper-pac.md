---
type: definition
id: efficient-marginal-nonuniform-weak-realizable-proper-pac
title: Efficient Marginal-Nonuniform Weak Realizable Proper PAC Learning
...
# Efficient Marginal-Nonuniform Weak Realizable Proper PAC Learning
...
WHERE type = "implication" AND source = "efficient-marginal-nonuniform-weak-realizable-proper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "efficient-marginal-nonuniform-weak-realizable-proper-pac"
SORT source ASC
```
