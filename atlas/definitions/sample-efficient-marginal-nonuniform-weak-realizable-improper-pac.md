---
type: definition
id: sample-efficient-marginal-nonuniform-weak-realizable-improper-pac
title: Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning
...
# Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning
...
WHERE type = "implication" AND source = "sample-efficient-marginal-nonuniform-weak-realizable-improper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "sample-efficient-marginal-nonuniform-weak-realizable-improper-pac"
SORT source ASC
```
