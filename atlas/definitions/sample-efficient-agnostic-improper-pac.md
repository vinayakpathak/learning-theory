---
type: definition
id: sample-efficient-agnostic-improper-pac
title: Sample-Efficient Agnostic Improper PAC Learning
...
# Sample-Efficient Agnostic Improper PAC Learning
...
WHERE type = "implication" AND source = "sample-efficient-agnostic-improper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "sample-efficient-agnostic-improper-pac"
SORT source ASC
```
