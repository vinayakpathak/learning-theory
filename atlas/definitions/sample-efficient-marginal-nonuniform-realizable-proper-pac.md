---
type: definition
id: sample-efficient-marginal-nonuniform-realizable-proper-pac
title: Sample-Efficient Marginal-Nonuniform Realizable Proper PAC Learning
...
# Sample-Efficient Marginal-Nonuniform Realizable Proper PAC Learning
...
WHERE type = "implication" AND source = "sample-efficient-marginal-nonuniform-realizable-proper-pac"
SORT target ASC
```
...
FROM "atlas/implications"
WHERE type = "implication" AND target = "sample-efficient-marginal-nonuniform-realizable-proper-pac"
SORT source ASC
```
