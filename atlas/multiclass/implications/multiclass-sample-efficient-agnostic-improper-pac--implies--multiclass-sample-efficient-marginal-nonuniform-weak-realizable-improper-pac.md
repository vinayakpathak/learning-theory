---
type: implication
id: multiclass-sample-efficient-agnostic-improper-pac__implies__multiclass-sample-efficient-marginal-nonuniform-weak-realizable-improper-pac
...
witnesses: []
refs: []
summary: 'The target only relaxes requirements already met by the source (distribution: distribution-free-to-marginal-nonuniform; strength: strong-to-weak; realizability: agnostic-to-realizable).'
...
# Multiclass Sample-Efficient Agnostic Improper PAC Learning $\Rightarrow$ Multiclass Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning
