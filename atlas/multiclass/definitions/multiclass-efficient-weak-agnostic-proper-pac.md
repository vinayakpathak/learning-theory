---
type: definition
id: multiclass-efficient-weak-agnostic-proper-pac
title: Multiclass Efficient Weak Agnostic Proper PAC Learning
...
# Multiclass Efficient Weak Agnostic Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-weak-agnostic-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-weak-agnostic-proper-pac"
SORT source ASC
```
