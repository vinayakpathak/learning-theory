---
type: definition
id: multiclass-sample-efficient-agnostic-proper-pac
title: Multiclass Sample-Efficient Agnostic Proper PAC Learning
...
# Multiclass Sample-Efficient Agnostic Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-sample-efficient-agnostic-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-sample-efficient-agnostic-proper-pac"
SORT source ASC
```
