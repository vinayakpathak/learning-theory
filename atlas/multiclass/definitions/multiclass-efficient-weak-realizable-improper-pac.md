---
type: definition
id: multiclass-efficient-weak-realizable-improper-pac
title: Multiclass Efficient Weak Realizable Improper PAC Learning
...
# Multiclass Efficient Weak Realizable Improper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-weak-realizable-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-weak-realizable-improper-pac"
SORT source ASC
```
