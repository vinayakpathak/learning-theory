---
type: definition
id: multiclass-efficient-weak-realizable-proper-pac
title: Multiclass Efficient Weak Realizable Proper PAC Learning
...
# Multiclass Efficient Weak Realizable Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-weak-realizable-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-weak-realizable-proper-pac"
SORT source ASC
```
