---
type: definition
id: multiclass-sample-efficient-realizable-improper-pac
title: Multiclass Sample-Efficient Realizable Improper PAC Learning
...
# Multiclass Sample-Efficient Realizable Improper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-sample-efficient-realizable-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-sample-efficient-realizable-improper-pac"
SORT source ASC
```
