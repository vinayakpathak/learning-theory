---
type: definition
id: multiclass-sample-efficient-weak-agnostic-improper-pac
title: Multiclass Sample-Efficient Weak Agnostic Improper PAC Learning
...
# Multiclass Sample-Efficient Weak Agnostic Improper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-sample-efficient-weak-agnostic-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-sample-efficient-weak-agnostic-improper-pac"
SORT source ASC
```
