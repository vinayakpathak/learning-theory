---
type: definition
id: multiclass-efficient-agnostic-proper-pac
title: Multiclass Efficient Agnostic Proper PAC Learning
...
# Multiclass Efficient Agnostic Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-agnostic-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-agnostic-proper-pac"
SORT source ASC
```
