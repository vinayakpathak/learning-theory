---
type: definition
id: multiclass-sample-efficient-weak-realizable-proper-pac
title: Multiclass Sample-Efficient Weak Realizable Proper PAC Learning
...
# Multiclass Sample-Efficient Weak Realizable Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-sample-efficient-weak-realizable-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-sample-efficient-weak-realizable-proper-pac"
SORT source ASC
```
