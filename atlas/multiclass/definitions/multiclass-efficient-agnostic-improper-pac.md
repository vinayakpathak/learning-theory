---
type: definition
id: multiclass-efficient-agnostic-improper-pac
title: Multiclass Efficient Agnostic Improper PAC Learning
...
# Multiclass Efficient Agnostic Improper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-agnostic-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-agnostic-improper-pac"
SORT source ASC
```
