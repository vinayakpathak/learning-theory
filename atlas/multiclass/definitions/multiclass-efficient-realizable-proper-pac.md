---
type: definition
id: multiclass-efficient-realizable-proper-pac
title: Multiclass Efficient Realizable Proper PAC Learning
...
# Multiclass Efficient Realizable Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-realizable-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-realizable-proper-pac"
SORT source ASC
```
