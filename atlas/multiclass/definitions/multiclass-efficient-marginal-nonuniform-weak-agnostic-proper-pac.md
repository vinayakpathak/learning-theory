---
type: definition
id: multiclass-efficient-marginal-nonuniform-weak-agnostic-proper-pac
title: Multiclass Efficient Marginal-Nonuniform Weak Agnostic Proper PAC Learning
...
# Multiclass Efficient Marginal-Nonuniform Weak Agnostic Proper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-marginal-nonuniform-weak-agnostic-proper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-marginal-nonuniform-weak-agnostic-proper-pac"
SORT source ASC
```
