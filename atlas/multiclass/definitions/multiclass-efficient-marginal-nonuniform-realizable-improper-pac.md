---
type: definition
id: multiclass-efficient-marginal-nonuniform-realizable-improper-pac
title: Multiclass Efficient Marginal-Nonuniform Realizable Improper PAC Learning
...
# Multiclass Efficient Marginal-Nonuniform Realizable Improper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-marginal-nonuniform-realizable-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-marginal-nonuniform-realizable-improper-pac"
SORT source ASC
```
