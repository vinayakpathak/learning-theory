---
type: definition
id: multiclass-efficient-realizable-improper-pac
title: Multiclass Efficient Realizable Improper PAC Learning
...
# Multiclass Efficient Realizable Improper PAC Learning
...
WHERE type = "implication" AND source = "multiclass-efficient-realizable-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-efficient-realizable-improper-pac"
SORT source ASC
```
