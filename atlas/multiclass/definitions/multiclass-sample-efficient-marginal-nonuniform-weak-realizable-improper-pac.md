---
type: definition
id: multiclass-sample-efficient-marginal-nonuniform-weak-realizable-improper-pac
title: Multiclass Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning
...
# Multiclass Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning
...
A learner receives i.i.d. labeled examples $(x,c(x))$, where $x \sim P$ and $c \in \mathcal C$. With probability at least $1-\delta$, it may output a multiclass hypothesis $h:\mathcal X\to\mathcal Y$ outside $\mathcal C$ such that
...
WHERE type = "implication" AND source = "multiclass-sample-efficient-marginal-nonuniform-weak-realizable-improper-pac"
SORT target ASC
```
...
FROM "atlas/multiclass/implications"
WHERE type = "implication" AND target = "multiclass-sample-efficient-marginal-nonuniform-weak-realizable-improper-pac"
SORT source ASC
```
