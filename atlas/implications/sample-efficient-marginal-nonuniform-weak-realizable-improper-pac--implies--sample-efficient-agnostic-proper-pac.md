---
type: implication
id: sample-efficient-marginal-nonuniform-weak-realizable-improper-pac__implies__sample-efficient-agnostic-proper-pac
...
# Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning $\Rightarrow$ Sample-Efficient Agnostic Proper PAC Learning
...
**Goal.** Decide whether a marginal-dependent polynomial sample bound can be replaced by one distribution-free polynomial bound for [[sample-efficient-agnostic-proper-pac|Sample-Efficient Agnostic Proper PAC Learning]].
