---
type: implication
id: sample-efficient-marginal-nonuniform-weak-realizable-improper-pac__implies__sample-efficient-weak-agnostic-improper-pac
...
# Sample-Efficient Marginal-Nonuniform Weak Realizable Improper PAC Learning $\Rightarrow$ Sample-Efficient Weak Agnostic Improper PAC Learning
...
**Goal.** Decide whether a marginal-dependent polynomial sample bound can be replaced by one distribution-free polynomial bound for [[sample-efficient-weak-agnostic-improper-pac|Sample-Efficient Weak Agnostic Improper PAC Learning]].
