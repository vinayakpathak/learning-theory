...
The analogous marginal-nonuniform weak proper target is not refuted by this active-slice reduction: there the runtime polynomial and weak advantage may depend on the active-slice marginal chosen from the input instance.
