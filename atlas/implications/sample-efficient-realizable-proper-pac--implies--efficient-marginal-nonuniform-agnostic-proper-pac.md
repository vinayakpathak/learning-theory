---
type: implication
id: sample-efficient-realizable-proper-pac__implies__efficient-marginal-nonuniform-agnostic-proper-pac
...
# Sample-Efficient Realizable Proper PAC Learning $\Rightarrow$ Efficient Marginal-Nonuniform Agnostic Proper PAC Learning
