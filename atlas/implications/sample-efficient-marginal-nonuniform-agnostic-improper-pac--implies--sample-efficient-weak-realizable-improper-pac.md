---
type: implication
id: sample-efficient-marginal-nonuniform-agnostic-improper-pac__implies__sample-efficient-weak-realizable-improper-pac
...
# Sample-Efficient Marginal-Nonuniform Agnostic Improper PAC Learning $\Rightarrow$ Sample-Efficient Weak Realizable Improper PAC Learning
...
**Goal.** Show that the source guarantee is enough for [[sample-efficient-weak-realizable-improper-pac|Sample-Efficient Weak Realizable Improper PAC Learning]] once polynomial running time is not required.
