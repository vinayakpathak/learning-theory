---
type: implication
id: sample-efficient-agnostic-proper-pac__implies__efficient-agnostic-proper-pac
...
# Sample-Efficient Agnostic Proper PAC Learning $\Rightarrow$ Efficient Agnostic Proper PAC Learning
