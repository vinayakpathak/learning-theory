---
type: implication
id: efficient-realizable-improper-pac__implies__efficient-weak-agnostic-improper-pac
...
# Efficient Realizable Improper PAC Learning $\Rightarrow$ Efficient Weak Agnostic Improper PAC Learning
...
**Goal.** Refute the implication by finding a class that is efficiently strongly realizably properly learnable but not weakly agnostically learnable, even improperly.
...
contradicting the lower bound. This directly rules out the weak agnostic improper target.
